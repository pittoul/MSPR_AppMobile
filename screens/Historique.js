      ...
      this.rightButtons = [
        ...
        // ><Text>X</Text></TouchableOpacity>
          <TouchableOpacity onPress={() => this._delete()}
                            style={styles.buttonDelete}>
              <FontAwesome name="trash-o"  backgroundColor="red"
              style={styles.iconDelete} size={28} > </FontAwesome>
          </TouchableOpacity>
      ];
    }
            ...
            >
                <View style={styles.container}>
                    ...
                    {this.state.discountsLinks.map((item, key) => (
                        <Swipeable leftContent={leftContent} rightButtons={this.rightButtons}>
